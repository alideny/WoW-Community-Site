...
// Display all errors   显示网页错误信息代码（error_reporting(E_ALL);）
error_reporting(E_ALL & ~E_NOTICE & ~E_WARNING & ~E_DEPRECATED);//屏蔽网页错误信息代码（error_reporting(E_ALL & ~E_NOTICE & ~E_WARNING & ~E_DEPRECATED);）
